...
import base58
import binascii
from bitcoinaddress2.key.key import Key
...
##        return self.pubkey,self.pubkeyc,self.mainnet.pubaddr1,self.mainnet.pubaddr1,self.mainnet.pubaddr1c,self.mainnet.pubaddr3,self.mainnet.pubaddrbc1_P2WPKH,self.mainnet.pubaddrbc1_P2WSH
    ...
    def get_mainnet_public_address_1(self):
        return self.mainnet.pubaddr1

    def get_mainnet_public_address_1_compressed(self):
        return self.mainnet.pubaddr1c

    def get_mainnet_public_address_3(self):
        return self.mainnet.pubaddr3

    def get_mainnet_public_P2WPKH(self):
        return self.mainnet.pubaddrbc1_P2WPKH

    def get_mainnet_public_P2WSH(self):
        return self.mainnet.pubaddrbc1_P2WSH
